  ...
  jQuery(document).ready(function($) {
    ...
    initLookupArea = function() {
      ...
      return $lookupAreaDropdown.on('change', function(e) {
        var $cartForm, $checkoutForm, $enabled, $label, data, fieldId, labelData, locationID, lookupField, objectType;
        ...
        if (true !== $enabled.is(':visible')) {
          ...
          block($cartForm);
          block($checkoutForm);
          lookupField = $('#pickup-location-field-for-' + fieldId).find('.pickup-location-lookup');
          objectType = $(lookupField).data('pickup-object-type');
          locationID = $(lookupField).val();
