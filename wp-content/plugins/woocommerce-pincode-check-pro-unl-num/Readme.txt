=== Woocommerce check pincode/zipcode for shipping and cod ===
...
* Shall I have to update pincodes one by one?

**Ans.** No, there is an option of **Import Zip codes** by which you can upload number of pincodes at a time .
...
1. This Screenshot shows all the manual settings of the plugin.
2. This screenshot shows all the Styling options of the plugin.
3. This section shows Image uploading options.
4. This screenshot shows how the settings looks on your site.
5. This page shows the option for bulk CSV upload.  
