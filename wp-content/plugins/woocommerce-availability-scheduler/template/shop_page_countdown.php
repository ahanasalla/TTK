...
<div class="countdown">
	<span id="clock<?php echo $product->id ?>"></span>
</div>
<script>
jQuery(document).ready(function()
{
	...
	if(difference >0)
	{
	 display = document.querySelector('#clock<?php echo $product->id ?>');
	...
	/* var seconds = wcst_mod(difference , 60); 
	 ...
	 jQuery('#clock<?php echo $product->id ?>').countdown(wcsa_data_formatter(end_date), function(event) {
