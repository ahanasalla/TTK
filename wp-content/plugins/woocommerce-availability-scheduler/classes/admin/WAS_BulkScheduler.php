		 ...
		 if(isset($_POST['was_selected_categories']))
			 foreach($_POST['was_selected_categories']['categories'] as $category)
			 {
				...
				foreach($products as $post_id)
				{
					...
					/* update_post_meta( $post_id, '_was_period', $_POST['_was_period'] );
					if(isset($_POST['_was_start_time']))
						update_post_meta( $post_id, '_was_start_time', $_POST['_was_start_time'] );
					if(isset($_POST['_was_end_time']))
						update_post_meta( $post_id, '_was_end_time', $_POST['_was_end_time'] );
					...
					update_post_meta( $post_id, '_was_expiring_date',  $_POST['_was_expiring_date'] );
					...
					if(isset($_POST['_was_customer_roles_restriction_message']))
		...
		<p>
			...
			<?php wp_nonce_field('wcas_action', 'wcas_bulkschedule'); ?>
				...
				<p style="margin-top:20px; margin-bottom:20px;" class="was-form-field checkbox-par">	
					...
					<input name="_was_visible_after_expiring_date" type="checkbox" value="1" <?php if(isset($visible_after_expiring_date)) echo 'checked="checked"';?>>
				</p>
